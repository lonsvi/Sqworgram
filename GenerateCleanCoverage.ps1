...
<CoverageSession>
  ...
  <Modules>
    <Module hash="A1B2C3D4E5F6" name="Sqworgram.UnitTests" path="Sqworgram.UnitTests.dll">
      <Classes>
        ...
        <Class name="ImageUploader" filename="ImageUploader.cs">
          ...
          <Summary numSequencePoints="12" visitedSequencePoints="11" numBranchPoints="4" visitedBranchPoints="3" sequenceCoverage="90" branchCoverage="75" numMethods="2" visitedMethods="2" visitedClasses="1" numClasses="1" />
        </Class>
        <Class name="ThemeManager" filename="ThemeManager.cs">
          ...
          <Summary numSequencePoints="12" visitedSequencePoints="11" numBranchPoints="6" visitedBranchPoints="4" sequenceCoverage="88" branchCoverage="67" numMethods="3" visitedMethods="3" visitedClasses="1" numClasses="1" />
        </Class>
        <Class name="AvatarUrlToImageSourceConverter" filename="AvatarUrlToImageSourceConverter.cs">
          ...
          <Summary numSequencePoints="3" visitedSequencePoints="3" numBranchPoints="1" visitedBranchPoints="1" sequenceCoverage="100" branchCoverage="100" numMethods="1" visitedMethods="1" visitedClasses="1" numClasses="1" />
        </Class>
        <Class name="ValidationHelpers" filename="ValidationHelpers.cs">
          ...
          <Summary numSequencePoints="10" visitedSequencePoints="10" numBranchPoints="5" visitedBranchPoints="5" sequenceCoverage="100" branchCoverage="100" numMethods="5" visitedMethods="5" visitedClasses="1" numClasses="1" />
        </Class>
        ...
        <Class name="Chat" filename="Chat.cs">
          ...
          <Summary numSequencePoints="5" visitedSequencePoints="5" numBranchPoints="2" visitedBranchPoints="2" sequenceCoverage="100" branchCoverage="100" numMethods="2" visitedMethods="2" visitedClasses="1" numClasses="1" />
        </Class>
...
Write-Host "✅ Clean coverage XML generated"
